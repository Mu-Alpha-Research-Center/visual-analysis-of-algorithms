...
test('breadth-first traverse', () => {
    ...
    expect(root.bft().map((node) => node.value)).toStrictEqual([
        'a',
        'b',
        'c',
        'd',
...
test('depth-first traverse', () => {
    ...
    expect(root.dftRecursive().map((node) => node.value)).toStrictEqual([
        'a',
        'b',
        'c',
        'd',
    ...
    expect(root.dftIterative().map((node) => node.value)).toStrictEqual([
        'a',
        'b',
        'c',
        'd',
